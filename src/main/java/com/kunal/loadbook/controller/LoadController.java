...
public class LoadController {
    ...
    @Operation(summary = "Get loads with filtering and pagination", 
               description = "Retrieves loads with optional filtering by shipper ID, truck type, and status")
    @ApiResponses(value = {
    ...
    public ResponseEntity<PagedResponse<LoadResponse>> getLoads(
            @Parameter(description = "Filter by shipper ID") 
            @RequestParam(required = false) String shipperId,
            
            @Parameter(description = "Filter by truck type") 
            @RequestParam(required = false) String truckType,
            
            @Parameter(description = "Filter by load status") 
