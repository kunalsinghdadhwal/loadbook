...
public class BookingController {
    ...
    @Operation(summary = "Get bookings with filtering and pagination", 
               description = "Retrieves bookings with optional filtering by load ID, transporter ID, and status")
    @ApiResponses(value = {
    ...
    public ResponseEntity<PagedResponse<BookingResponse>> getBookings(
            @Parameter(description = "Filter by load ID") 
            @RequestParam(required = false) UUID loadId,
            
            @Parameter(description = "Filter by transporter ID") 
        ...
        PagedResponse<BookingResponse> response = bookingService.getBookings(loadId, transporterId, status, page, size);
